...
# Carregar o modelo de reconhecimento de texto pré-treinado
pipeline = keras_ocr.pipeline.Pipeline()

# Carregar uma imagem de exemplo
folder = r'crop_yolov7x/antiga'
...
for filename in os.listdir(folder):
    ...
    # Executar o pipeline na imagem
    images = [keras_ocr.tools.read(imgGray)]
    ...
    for predictions in prediction_groups:
        ...
        # print("Placa: ", filename, "Reconhecimento: ", text)
